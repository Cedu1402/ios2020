...
class MasterTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // self.tableView.dataSource =  DataProvider.sharedInstance.memberPersons
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = DataProvider.sharedInstance.memberPersons[indexPath.row].firstName
        return cell
    }
